;(function(){
	...
	var helpers = {
      	...
      	take_check : function(terms  , checking_obj      )
      	{
      			...
      			for( key in terms )
      			{
      					...
      					if(( Object.prototype.toString.call( term_value ) === '[object Array]' ))
      					{
      							checked = term_value.some(function( term_value_inner ){
      								return helpers.take_check({ x:term_value_inner },{ x:checking_obj_value});
      							});
      					}
      					else
      					{
    ...
    {
        Array.prototype.take = function(condition)
        {
            ...
            result = this.filter(function( element ){
                ...
                return ( helpers.take_check( condition, element ) );
